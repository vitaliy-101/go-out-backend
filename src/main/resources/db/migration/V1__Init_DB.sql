...
insert into playground (town, street, type, longitude, latitude, playground_state, current_book_state, file_data) values
                                                                                                                      ('Москва', 'Тверская', 'Футбол', 37.6176, 55.7558, 1, true, null),
                                                                                                                      ('Питер', 'Невский', 'Теннис', 30.3308, 59.9343, 2, false, null),
                                                                                                                      ('Екатеринбург', 'Ленина', 'Баскетбол', 60.5949, 56.8389, 1, true, null),
                                                                                                                      ('Новосибирск', 'Красный проспект', 'Футбол', 82.9214, 55.0415, 3, true, null),
                                                                                                                      ('Казань', 'Баумана', 'Теннис', 49.1221, 55.7887, 2, false, null),
                                                                                                                      ('Нижний Новгород', 'Минина', 'Баскетбол', 45.0021, 56.2965, 1, true, null),
                                                                                                                      ('Челябинск', 'Кировка', 'Хоккей', 61.4368, 55.1605, 4, true, null),
                                                                                                                      ('Самара', 'Ленинградская', 'Волейбол', 50.1005, 53.1951, 2, true, null),
                                                                                                                      ('Омск', 'Ленина', 'Регби', 73.4025, 54.9892, 1, true, null),
                                                                                                                      ('Уфа', 'Проспект Октября', 'Бокс', 55.9271, 54.7388, 3, false, null),
                                                                                                                      ('Краснодар', 'Красная', 'Плавание', 38.9792, 45.0350, 2, true, null),
                                                                                                                      ('Воронеж', 'Пролетарская', 'Гольф', 39.1190, 51.6710, 3, false, null),
                                                                                                                      ('Ростов-на-Дону', 'Большая Садовая', 'Легкая атлетика', 39.7170, 47.2357, 2, true, null);
